...
public class DateTimeUtils extends NgnDateTimeUtils{
	...
	public static String getTodayName(){
		if(sTodayName == null){
			sTodayName = FlyMobileApplication.getContext().getResources().getString(R.string.day_today);
		}
		return sTodayName;
	}
	...
	public static String getYesterdayName(){
		if(sYesterdayName == null){
			sYesterdayName = FlyMobileApplication.getContext().getResources().getString(R.string.day_yesterday);
		}
