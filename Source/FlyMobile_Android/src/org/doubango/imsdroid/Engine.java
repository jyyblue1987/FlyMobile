...
public class Engine extends NgnEngine{
	...
	private void showNotification(int notifId, int drawableId, String tickerText) {
        ...
        Intent intent = new Intent(FlyMobileApplication.getContext(), Main.class);
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(FlyMobileApplication.getContext(), notifId/*requestCode*/, intent, PendingIntent.FLAG_UPDATE_CURRENT);     

        // Set the info for the views that show in the notification panel.
        notification.setLatestEventInfo(FlyMobileApplication.getContext(), CONTENT_TITLE, tickerText, contentIntent);
