...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public void setLabelSize(int unit, float size) {
		setLabelSize(unit, size, Mode.BOTH);
	}
	 ...
	 *             {@link #getLoadingLayoutProxy(boolean, boolean)}.
	 */
	public void setLabelSize(int unit, float size, Mode mode) {
		getLoadingLayoutProxy(mode.showHeaderLoadingLayout(), mode.showFooterLoadingLayout()).setLabelSize(
				unit, size);
	}
	
	public void setLabelColor(int color) {
		setLabelColor(color, Mode.BOTH);
	}
	 ...
	 *             {@link #getLoadingLayoutProxy(boolean, boolean)}.
	 */
	public void setLabelColor(int color, Mode mode) {
		getLoadingLayoutProxy(mode.showHeaderLoadingLayout(), mode.showFooterLoadingLayout()).setLabelColor(
				color);
	}
